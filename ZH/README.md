...
**更新 2026-05-19（v1.0.1）**：Codex 外部稽核對 v1.0 回傳 **HOLD** 裁決，並指出 3 critical + 2 minor 問題——皆已於 v1.0.1 處理完畢。完整稽核歷程（哪些採納、哪些反駁、哪些延到 v1.0.2）記錄於 [`CHANGELOG.md`](../CHANGELOG.md)。下方表格涵蓋仍屬 v2 未來工作的結構性問題。
